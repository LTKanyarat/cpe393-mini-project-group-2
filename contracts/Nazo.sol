 ...
 *
 *                              NFT Contract
 * Author: Kanyarat 5215, Nuntaporn 5209
 * SutdentID: 63070505209,63070505215
 * ContractName: Nazo
 *
 **********************************************************************************
 */

contract Nazo is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Nazo: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Nazo NFT", "NAZO") {
        owner = msg.sender;
    }
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "Nazo: not exist");
