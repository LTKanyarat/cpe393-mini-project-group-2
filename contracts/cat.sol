 ...
 *
 *                              NFT Contract
 * Author: Kanyarat 5215
 * SutdentID: 63070505215
 * ContractName: Cat
 *
 **********************************************************************************
 */

contract Cat is ERC721A {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "Cat: not owner");
        _;
    }
     ...
     */
    constructor() ERC721A("Cat NFT", "CAT") {
        owner = msg.sender;
    }
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "Cat: not exist");
